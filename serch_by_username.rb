...
opt.banner = "Usage: search_by_username.rb [options]"
OPT = {}

opt.on("-n", "--name=NAME", String, "NAME. Ignore case.") {|v|
  OPT[:name] = v
}
...
res = conn.get resource, username
